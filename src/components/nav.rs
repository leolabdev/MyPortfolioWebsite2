...
//                 </li>
//                 <li>
//                     <a href="https://drive.google.com/file/d/1roSodsRcVNLScHU9ZzziS8zeNP9hSjjl" target="_blank" class="bg-hotmag py-2 px-4 rounded font- bg-custom-special hover:bg-custom-active">
//                         {"Resume"}
//                     </a>
//                 </li>
//             </ul>
